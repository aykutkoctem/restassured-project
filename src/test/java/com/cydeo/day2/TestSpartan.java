...
public class TestSpartan {
    ...
    public void testOneSpartan(){
        ...
        Response response = get("http://54.236.150.168:8000/api/spartans/1");
    ...
    public void testJSONBody(){
         ...
         */
        // sending a get request to this url and saving the response into Response object
        Response response = get("http://54.236.150.168:8000/api/spartans/903");
        // print out the body
        response.prettyPrint() ;
        ...
        Assertions.assertEquals(903 , myId);
        Assertions.assertEquals("Yelaffm" , myName);
        Assertions.assertEquals("Female" , myGender);
        Assertions.assertEquals(1222231230L , myPhone);
